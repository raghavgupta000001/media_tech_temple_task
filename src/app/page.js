  ...
  return (
    <div className="flex flex-col min-h-screen bg-white pb-24 font-sans">
      ...
      <div className="px-6 flex flex-col items-center">
        ...
        {/* Name */}
        <h1 className="text-xl font-bold text-gray-800 mb-4">Raghav Gupta</h1>

        {/* Bio Info */}
        {!showSettings ? (
          <div className="flex flex-col w-full space-y-2 text-sm text-gray-500">
            <div className="flex items-center gap-3"><MapPin className="w-4 h-4" />Bhiwadi, Rajasthan</div>
            <div className="flex items-center gap-3"><Globe className="w-4 h-4" /> Speak English at beginner level</div>
            <div className="flex items-center gap-3"><Briefcase className="w-4 h-4" /> Full Stack Developer</div>
          </div>
        ) : (
          <p className="text-sm text-gray-400 mb-2">raghav.gupta000001@gmail.com</p>
        )}
      </div>
        ...
        <>
          ...
          <div className="px-6 mt-8">
            ...
            <div className="border border-gray-200 rounded-2xl p-4 w-[45%] shadow-sm">
              ...
              <p className="font-bold text-sm text-gray-800">Full Stack Developer</p>
